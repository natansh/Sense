...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <header class="entry-header">
        <?php sense_posted_on(); ?>
        <h2 class="entry-title visuallyhidden"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'sense' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
    </header><!-- .entry-header -->
